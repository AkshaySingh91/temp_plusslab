  ...
  return (
    <div className='w-full py-12 px-6'>
      ...
      <div className='flex flex-wrap justify-around gap-5 lg:px-36 flex-row'>
        <div className='h-60 w-80 bg-[#feeb68] rounded-2xl p-5 relative overflow-hidden'>
        ...
        <div className='h-60 w-80 bg-[#a0e2e1] rounded-2xl p-5 relative overflow-hidden'>
        ...
        <div className='h-60 w-80 bg-[#fec091] rounded-2xl p-5 relative overflow-hidden'>
